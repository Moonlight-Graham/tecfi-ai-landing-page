...
contract XNAPZAirdropOpenClaim is Ownable {
    IERC20 public immutable xnapz; // ✅ Proper state variable declaration

    uint256 public constant CLAIM_AMOUNT = 500 * 10**6; // 500 XNAPZ
    ...
    constructor(IERC20 _xnapz) Ownable(msg.sender) {
        xnapz = _xnapz;
    }
    ...
    function claimPhase1() external {
        ...
        xnapz.transfer(msg.sender, CLAIM_AMOUNT);
